...
function commentTest(props) {
  ...
  const [status, setStatus] = useState("Комментарии");
              ...
              {status == "Комментарии" ? (
                ...
                >
                  <View style={{ flexDirection: "row" }}>
                    ...
                    >
                      <Text style={styles.textName}>Александр Роттенберг</Text>
                      <Text style={styles.textUsername}>@alexrot</Text>
                    </View>
                  </View>
                  <Text style={styles.textComment}>
                    Мир не стоит на месте — улучшается качество жизни, создаются
                    новые технологии. Глобализация ускоряет эти процессы
                    благодаря обмену информацией, знаниями и культурными
                    ценностями.
                  </Text>
                </View>
              )}
...
export default connect(mapStateToProps, mapDispatchProps)(commentTest);
